...
- Desktop session with accessibility permissions (macOS) or X11/XWayland (Linux)
...
| Press Key | `usecomputer press "cmd+s"` |
...
- Windows automation is not supported by this native skill; use only on macOS or Linux.
